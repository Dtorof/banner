...
useHead({
  title: 'Banner',
  meta: [
    { name: 'Carousel', content: 'My Banner site.' }
  ],
  bodyAttrs: {
    class: 'test'
  },
...
<template>
    ...
    <div class="carousel">
        <transition name="slide">
            <img :src="img[imgIndex]" :key="imgIndex" class="img-responsive" alt="Carousel">
        </transition>

        <div class="buttons">
            <i @click="prevImage" class="animate__animated animate__fadeIn " aria-label="Right"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <i @click="nextImage" class="animate__animated animate__fadeIn " aria-label="Left"><svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 256 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                    <path
        ...
        <div class="gallery-pagination">
            <ul>
                <li v-for="(image, index) in img" :key="index">
                    <button @click="imgIndex = index" :class="paginationSelect(index)" aria-label="Pagination"></button>
                </li>
